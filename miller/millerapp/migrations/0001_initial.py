# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-04-10 21:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_type', models.IntegerField(choices=[(1, 'Work'), (2, 'Home'), (3, 'Cell'), (4, 'Fax')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(blank=True, choices=[(1, 'On Hold'), (2, 'Construction'), (3, 'PreConstruction'), (4, 'Prospect'), (5, 'Bidding to Subtrades'), (6, 'Project on Hold'), (7, 'Project Awarded'), (8, 'Design Phase'), (9, 'Estimating')])),
                ('architect', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project_architect', to='millerapp.Person')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project_owner', to='millerapp.Person')),
            ],
        ),
        migrations.CreateModel(
            name='ProjectAddress',
            fields=[
                ...
                ('state', models.CharField(choices=[('AK', 'Alaska'), ('AL', 'Alabama'), ('AR', 'Arkansas'), ('AZ', 'Arizona'), ('CA', 'California'), ('CO', 'Colorado'), ('CT', 'Connecticut'), ('DE', 'Delaware'), ('FL', 'Florida'), ('GA', 'Georgia'), ('HI', 'Hawaii'), ('IA', 'Iowa'), ('ID', 'Idaho'), ('IL', 'Illinois'), ('IN', 'Indiana'), ('KS', 'Kansas'), ('KY', 'Kentucky'), ('LA', 'Louisiana'), ('MA', 'Massachusetts'), ('MD', 'Maryland'), ('ME', 'Maine'), ('MI', 'Michigan'), ('MN', 'Minnesota'), ('MO', 'Missouri'), ('MS', 'Mississippi'), ('MT', 'Montana'), ('NC', 'North Carolina'), ('ND', 'North Dakota'), ('NE', 'Nebraska'), ('NH', 'New Hampshire'), ('NJ', 'New Jersey'), ('NM', 'New Mexico'), ('NV', 'Nevada'), ('NY', 'New York'), ('OH', 'Ohio'), ('OK', 'Oklahoma'), ('OR', 'Oregon'), ('PA', 'Pennsylvania'), ('RI', 'Rhode Island'), ('SC', 'South Carolina'), ('SD', 'South Dakota'), ('TN', 'Tennessee'), ('TX', 'Texas'), ('UT', 'Utah'), ('VA', 'Virginia'), ('VT', 'Vermont'), ('WA', 'Washington'), ('WI', 'Wisconsin'), ('WV', 'West Virginia'), ('WY', 'Wyoming'), ('DC', 'District of Columbia')], max_length=2)),
                ('zip_code', models.CharField(max_length=16)),
                ('project', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='millerapp.Project')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[(1, 'Manager'), (2, 'Superintendent'), (3, 'Coordinator'), (4, 'Estimator')], max_length=50)),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='millerapp.Person')),
                ('project', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='millerapp.Project')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
